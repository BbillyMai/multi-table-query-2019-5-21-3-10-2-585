...
UNION
select * from student_course where courseId = 2
...
select s.name, sc.score from student s, course c, student_course sc where s.id = sc.studentId and c.id = sc.courseId
